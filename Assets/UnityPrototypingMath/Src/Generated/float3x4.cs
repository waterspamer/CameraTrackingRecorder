...
namespace AntilatencyMath {
    ...
    using numberMxN = float3x4;
    using numberNxM = float4x3;
    ...
    public partial struct float3x4 {
        ...
        public float3x4(numberN row0, numberN row1, numberN row2) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
        }
        ...
        public double3x4 toDouble3x4() {
            return new double3x4(row0.toDouble4(), row1.toDouble4(), row2.toDouble4());
        }
        ...
        public static float3x2 operator * (numberMxN a, float4x2 b) {
        ...
        public static float3x3 operator * (numberMxN a, float4x3 b) {
        ...
        public static float3x4 operator * (numberMxN a, float4x4 b) {
