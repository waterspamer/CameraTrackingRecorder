...
namespace AntilatencyMath {
    ...
    using numberMxN = double2x2;
    using numberNxM = double2x2;
    ...
    public partial struct double2x2 {
        ...
        public double2x2(numberN row0, numberN row1) {
            this.row0 = row0;
            this.row1 = row1;
        }
        ...
        public float2x2 toFloat2x2() {
            return new float2x2(row0.toFloat2(), row1.toFloat2());
        }
        ...
        public static double2x2 operator * (numberMxN a, double2x2 b) {
        ...
        public static double2x3 operator * (numberMxN a, double2x3 b) {
        ...
        public static double2x4 operator * (numberMxN a, double2x4 b) {
