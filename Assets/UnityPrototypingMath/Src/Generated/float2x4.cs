...
namespace AntilatencyMath {
    ...
    using numberMxN = float2x4;
    using numberNxM = float4x2;
    ...
    public partial struct float2x4 {
        ...
        public float2x4(numberN row0, numberN row1) {
            this.row0 = row0;
            this.row1 = row1;
        }
        ...
        public double2x4 toDouble2x4() {
            return new double2x4(row0.toDouble4(), row1.toDouble4());
        }
        ...
        public static float2x2 operator * (numberMxN a, float4x2 b) {
        ...
        public static float2x3 operator * (numberMxN a, float4x3 b) {
        ...
        public static float2x4 operator * (numberMxN a, float4x4 b) {
