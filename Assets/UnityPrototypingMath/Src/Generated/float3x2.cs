...
namespace AntilatencyMath {
    ...
    using numberMxN = float3x2;
    using numberNxM = float2x3;
    ...
    public partial struct float3x2 {
        ...
        public float3x2(numberN row0, numberN row1, numberN row2) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
        }
        ...
        public double3x2 toDouble3x2() {
            return new double3x2(row0.toDouble2(), row1.toDouble2(), row2.toDouble2());
        }
        ...
        public static float3x2 operator * (numberMxN a, float2x2 b) {
        ...
        public static float3x3 operator * (numberMxN a, float2x3 b) {
        ...
        public static float3x4 operator * (numberMxN a, float2x4 b) {
