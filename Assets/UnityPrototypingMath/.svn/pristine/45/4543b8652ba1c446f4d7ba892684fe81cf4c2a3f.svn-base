...
namespace AntilatencyMath {
    ...
    using numberD = double3;
    using numberMxN = double4x3;
    using numberNxM = double3x4;
    ...
    public partial struct double4x3 {
        ...
        public double4x3(numberN row0, numberN row1, numberN row2, numberN row3) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
            this.row3 = row3;
        ...
        public float4x3 toFloat4x3() {
            return new float4x3(row0.toFloat3(), row1.toFloat3(), row2.toFloat3(), row3.toFloat3());
        }
        ...
        public static double4x2 operator * (numberMxN a, double3x2 b) {
        ...
        public static double4x3 operator * (numberMxN a, double3x3 b) {
        ...
        public static double4x4 operator * (numberMxN a, double3x4 b) {
