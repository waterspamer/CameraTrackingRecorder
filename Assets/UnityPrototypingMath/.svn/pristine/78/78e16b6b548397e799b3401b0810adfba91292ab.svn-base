...
namespace AntilatencyMath {
    ...
    using numberMxN = double3x3;
    using numberNxM = double3x3;
    ...
    public partial struct double3x3 {
        ...
        public double3x3(numberN row0, numberN row1, numberN row2) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
        }
        ...
        public float3x3 toFloat3x3() {
            return new float3x3(row0.toFloat3(), row1.toFloat3(), row2.toFloat3());
        }
        ...
        public static double3x2 operator * (numberMxN a, double3x2 b) {
        ...
        public static double3x3 operator * (numberMxN a, double3x3 b) {
        ...
        public static double3x4 operator * (numberMxN a, double3x4 b) {
