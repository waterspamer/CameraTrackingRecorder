...
namespace AntilatencyMath {
    ...
    using numberMxN = float4x2;
    using numberNxM = float2x4;
    ...
    public partial struct float4x2 {
        ...
        public float4x2(numberN row0, numberN row1, numberN row2, numberN row3) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
            this.row3 = row3;
        ...
        public double4x2 toDouble4x2() {
            return new double4x2(row0.toDouble2(), row1.toDouble2(), row2.toDouble2(), row3.toDouble2());
        }
        ...
        public static float4x2 operator * (numberMxN a, float2x2 b) {
        ...
        public static float4x3 operator * (numberMxN a, float2x3 b) {
        ...
        public static float4x4 operator * (numberMxN a, float2x4 b) {
