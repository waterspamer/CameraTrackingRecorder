...
namespace AntilatencyMath {
    ...
    using numberMxN = double3x4;
    using numberNxM = double4x3;
    ...
    public partial struct double3x4 {
        ...
        public double3x4(numberN row0, numberN row1, numberN row2) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
        }
        ...
        public numberM col(int iCol) {
            ...
            switch (iCol) {
                ...
                case 3: return new numberM(row0.w, row1.w, row2.w);
            }
        }
        ...
        public float3x4 toFloat3x4() {
            return new float3x4(row0.toFloat4(), row1.toFloat4(), row2.toFloat4());
        }
        ...
        public static double3x2 operator * (numberMxN a, double4x2 b) {
        ...
        public static double3x3 operator * (numberMxN a, double4x3 b) {
        ...
        public static double3x4 operator * (numberMxN a, double4x4 b) {
