...
namespace AntilatencyMath {
    ...
    using numberMxN = double2x3;
    using numberNxM = double3x2;
    ...
    public partial struct double2x3 {
        ...
        public double2x3(numberN row0, numberN row1) {
            this.row0 = row0;
            this.row1 = row1;
        }
        ...
        public float2x3 toFloat2x3() {
            return new float2x3(row0.toFloat3(), row1.toFloat3());
        }
        ...
        public static double2x2 operator * (numberMxN a, double3x2 b) {
        ...
        public static double2x3 operator * (numberMxN a, double3x3 b) {
        ...
        public static double2x4 operator * (numberMxN a, double3x4 b) {
