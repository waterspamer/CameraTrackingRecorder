...
namespace AntilatencyMath {
    ...
    using numberD = double4;
    using numberMxN = double4x4;
    using numberNxM = double4x4;
    ...
    public partial struct double4x4 {
        ...
        public double4x4(numberN row0, numberN row1, numberN row2, numberN row3) {
            this.row0 = row0;
            this.row1 = row1;
            this.row2 = row2;
            this.row3 = row3;
        ...
        public float4x4 toFloat4x4() {
            return new float4x4(row0.toFloat4(), row1.toFloat4(), row2.toFloat4(), row3.toFloat4());
        }
        ...
        public static double4x2 operator * (numberMxN a, double4x2 b) {
        ...
        public static double4x3 operator * (numberMxN a, double4x3 b) {
        ...
        public static double4x4 operator * (numberMxN a, double4x4 b) {
