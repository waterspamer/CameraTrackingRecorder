...
namespace AntilatencyMath {
    ...
    using numberMxN = float2x3;
    using numberNxM = float3x2;
    ...
    public partial struct float2x3 {
        ...
        public float2x3(numberN row0, numberN row1) {
            this.row0 = row0;
            this.row1 = row1;
        }
        ...
        public double2x3 toDouble2x3() {
            return new double2x3(row0.toDouble3(), row1.toDouble3());
        }
        ...
        public static float2x2 operator * (numberMxN a, float3x2 b) {
        ...
        public static float2x3 operator * (numberMxN a, float3x3 b) {
        ...
        public static float2x4 operator * (numberMxN a, float3x4 b) {
